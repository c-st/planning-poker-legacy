...
import JsonCoding exposing (decodePayload, userEstimationEncoded, requestEstimationEncoded)
import WebSocket
...
update msg model =
    case msg of
        ...
        RequestShowResult ->
            ( model
            , (sendPayload model.user model.roomId) (requestEstimationEncoded model.user)
            )
