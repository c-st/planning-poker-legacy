...
case class UserJoined(userName: String,
                      ...
                      eventType: String = "userJoined")
    extends PokerEvent

case class UserLeft(userName: String, eventType: String = "userLeft")
    extends PokerEvent

case class RequestStartEstimation(userName: String,
                                  taskName: String,
                                  startDate: String,
                                  eventType: String = "startEstimation")
    extends PokerEvent

case class UserEstimate(userName: String,
                        taskName: String,
                        estimate: String,
                        eventType: String = "estimate")
    extends PokerEvent

case class UserHasEstimated(userName: String,
                            taskName: String,
                            eventType: String = "userHasEstimated")
    extends PokerEvent

case class RequestShowEstimationResult(userName: String,
                                       eventType: String = "showResult")
    extends PokerEvent
...
case class EstimationResult(taskName: String,
                            ...
                            eventType: String = "estimationResult")
    extends PokerEvent
